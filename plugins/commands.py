...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 Uᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Waldy_Writings')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔎 Support 🔍', url='https://t.me/WaldyWritings_Bot')
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('ᴀᴍᴀᴢɪɴɢ ᴄᴏᴅᴇ ғʀᴏᴍ ᴡᴀʟᴅʏ_ᴡʀɪᴛɪɴɢꜱ')
