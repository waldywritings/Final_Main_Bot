...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("Malla Search Chessuko Bruhh !!!", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    btn.insert(0, [
        InlineKeyboardButton("😌 ᴘᴀᴍᴘɪɴᴄʜᴀᴀ ᴄʜᴏᴏꜱᴜᴋᴏ ᴍᴀᴡᴀ 😌", url=f"https://t.me/{temp.U_NAME}")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer(' ˆ°• ᴡᴀʟᴅʏ_ᴡʀɪᴛɪɴɢꜱ •°ˆ ')
            else:
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
                ...
                await query.answer("Idhi Needhi Kaadhu Mawa, Needhi Nuvvu Search Chessuko", show_alert=True)
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 Mᴏᴠɪᴇ Uᴘᴅᴀᴛᴇs 💥', url='https://t.me/Waldy_Writings'),
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Uᴩᴅᴀᴛᴇs 😜', url='https://t.me/Waldy_Writings'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😊 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ ☺', url='https://t.me/Waldy_TXT/3')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😊 Rᴇᴩᴏ 😊', url='https://t.me/Waldy_TXT/3')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😪 Hᴏᴡ Tᴏ Oᴩᴇɴ Mʏ Lɪɴᴋs 💢', url='https://t.me/howtouseourbot/4')
        ], [
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ 📟', callback_data='contact')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ...
        buttons = [[
            InlineKeyboardButton('😳 Cʀᴇᴀᴛᴏʀ 😳', url='https://t.me/Waldy_Writings')
        ], [     
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ 📟', url='https://t.me/WaldyWritings_Bot')
        ], [  
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ], [
        ]]
    ...
    await query.answer(' ˆ°• ᴡᴀʟᴅʏ_ᴡʀɪᴛɪɴɢꜱ •°ˆ ')
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ Hᴇʏ Fʀɪᴇɴᴅ {message.from_user.first_name} 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ !\n\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝Cᴏɴᴛᴇɴᴛ Nᴀᴍᴇ : {search}\n\n➟ 👮 Rᴇǫᴜᴇsᴛᴇᴅ Bʏ Yᴏᴜ : {message.from_user.first_name}\n\n༺ @WaldyWritings_Bot༻\n\n🦋・‥☆Sᴜᴩᴩᴏʀᴛ Oᴜʀ Cʜᴀɴɴᴇʟ ☆‥・🦋\n╰┈➤・☆ @Waldy_Writings ☆",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  Aᴅᴅ Mᴇ Tᴏ Uʀ Gʀᴏᴜᴩ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪ ᴡᴀʟᴅʏ_ᴡʀɪᴛɪɴɢꜱ ✪", url="https://t.me/Waldy_Writings"), InlineKeyboardButton("✪ Sᴜᴩᴩᴏʀᴛ ✪", url="https://t.me/WaldyWritings_bot"), InlineKeyboardButton("✪ Rᴇᴩᴏ ✪", url="https://t.me/Waldy_TXT/3")],[InlineKeyboardButton("╚»♥️Dᴇʟᴇᴛᴇ Tʜɪs Mᴇssᴀɢᴇ ♥️«╝", callback_data="close_data")]]))
